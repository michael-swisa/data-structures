...
{
    internal class TesterLinkedList
    {
        public static void Main()
        {
            ...
            try
            {
                ...
                {
                    Console.WriteLine(
                        "Test 4 Passed: Removing all instances of a value from the list."
                    );
                    passedTests++;
                }
                else
            ...
            try
            {
                ...
                {
                    Console.WriteLine(
                        "Test 6 Passed: Finding an element returns the correct index."
                    );
                    passedTests++;
                }
                else
            ...
            try
            {
                ...
                {
                    Console.WriteLine(
                        "Test 7 Failed: Incorrect result for finding a non-existent element."
                    );
                }
            }
            catch
            ...
            try
            {
                ...
                {
                    Console.WriteLine(
                        "Test 9 Failed: Removing from an empty list should not change length."
                    );
                }
            }
            catch
            ...
            try
            {
                ...
                {
                    Console.WriteLine(
                        "Test 11 Failed: Incorrect value returned for out of range index."
                    );
                }
            }
            catch
